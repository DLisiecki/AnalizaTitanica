...
class DataExplorer:
    ...
    def show_victims_by_sex(self):
        ...
        plt.xticks(data_by_sex_count.index, ["Mężczyźni", "Kobiety"])
        plt.grid(axis='y')
        plt.show()
    ...
    def show_age(self):
        ...
        male_data = self.data[self.data["Sex"] == "female"]
        female_data = self.data[self.data["Sex"] == "male"]
        ...
        axs[1].hist(female_data["Age"], bins=20, color="#ff7f0e", width = 3.2, alpha=0.8)
